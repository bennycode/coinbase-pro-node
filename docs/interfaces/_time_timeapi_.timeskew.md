...
_Defined in [src/time/TimeAPI.ts:5](https://github.com/bennycode/coinbase-pro-node/blob/accd6f4/src/time/TimeAPI.ts#L5)_
...
_Defined in [src/time/TimeAPI.ts:7](https://github.com/bennycode/coinbase-pro-node/blob/accd6f4/src/time/TimeAPI.ts#L7)_
