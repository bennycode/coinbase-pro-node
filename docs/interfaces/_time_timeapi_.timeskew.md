...
_Defined in [src/time/TimeAPI.ts:5](https://github.com/bennyn/coinbase-pro-node/blob/26bf4d8/src/time/TimeAPI.ts#L5)_
...
_Defined in [src/time/TimeAPI.ts:7](https://github.com/bennyn/coinbase-pro-node/blob/26bf4d8/src/time/TimeAPI.ts#L7)_
