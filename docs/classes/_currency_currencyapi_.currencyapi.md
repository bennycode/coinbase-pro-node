...
_Defined in [src/currency/CurrencyAPI.ts:32](https://github.com/bennyn/coinbase-pro-node/blob/d0dceee/src/currency/CurrencyAPI.ts#L32)_
...
_Defined in [src/currency/CurrencyAPI.ts:43](https://github.com/bennyn/coinbase-pro-node/blob/d0dceee/src/currency/CurrencyAPI.ts#L43)_
...
_Defined in [src/currency/CurrencyAPI.ts:30](https://github.com/bennyn/coinbase-pro-node/blob/d0dceee/src/currency/CurrencyAPI.ts#L30)_

### CURRENCIES

• **CURRENCIES**: _string_ = `/currencies`

_Defined in [src/currency/CurrencyAPI.ts:31](https://github.com/bennyn/coinbase-pro-node/blob/d0dceee/src/currency/CurrencyAPI.ts#L31)_
