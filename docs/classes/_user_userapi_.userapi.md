...
_Defined in [src/user/UserAPI.ts:17](https://github.com/bennyn/coinbase-pro-node/blob/a33aec9/src/user/UserAPI.ts#L17)_
...
_Defined in [src/user/UserAPI.ts:39](https://github.com/bennyn/coinbase-pro-node/blob/a33aec9/src/user/UserAPI.ts#L39)_
...
_Defined in [src/user/UserAPI.ts:26](https://github.com/bennyn/coinbase-pro-node/blob/a33aec9/src/user/UserAPI.ts#L26)_
...
_Defined in [src/user/UserAPI.ts:15](https://github.com/bennyn/coinbase-pro-node/blob/a33aec9/src/user/UserAPI.ts#L15)_

### USERS

• **USERS**: _string_ = `/users`

_Defined in [src/user/UserAPI.ts:16](https://github.com/bennyn/coinbase-pro-node/blob/a33aec9/src/user/UserAPI.ts#L16)_
