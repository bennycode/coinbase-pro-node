...
_Defined in [src/user/UserAPI.ts:17](https://github.com/bennyn/coinbase-pro-node/blob/2af663b/src/user/UserAPI.ts#L17)_
...
_Defined in [src/user/UserAPI.ts:41](https://github.com/bennyn/coinbase-pro-node/blob/2af663b/src/user/UserAPI.ts#L41)_
...
_Defined in [src/user/UserAPI.ts:27](https://github.com/bennyn/coinbase-pro-node/blob/2af663b/src/user/UserAPI.ts#L27)_
...
_Defined in [src/user/UserAPI.ts:15](https://github.com/bennyn/coinbase-pro-node/blob/2af663b/src/user/UserAPI.ts#L15)_

### USERS

• **USERS**: _string_ = `/users`

_Defined in [src/user/UserAPI.ts:16](https://github.com/bennyn/coinbase-pro-node/blob/2af663b/src/user/UserAPI.ts#L16)_
